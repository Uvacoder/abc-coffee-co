    ...
    return (
        <div className={styles.container}>
            <div className={styles.imgContainer}>
                <Image  src="/assets/about/desktop/image-commitment.jpg" alt="commitment image" width="445" height="520"  className={styles.img} />
            </div>
            <div className={styles.imgContainerTablet}>
                <Image  src="/assets/about/tablet/image-commitment.jpg" alt="commitment image" width="281" height="470"  className={styles.img} />
            </div>
            <div className={styles.imgContainerMobile}>
                <Image  src="/assets/about/mobile/image-commitment.jpg" alt="commitment image" width="327" height="400"  className={styles.img} />
            </div>
